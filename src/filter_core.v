module filter_core #(
    ...
    function [3:0] rgb444_to_gray4;
        ...
        reg [5:0] gray_sum;
        begin
            // แปลงเป็น grayscale แบบง่าย: (R + 2G + B) / 4
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (pixel_valid) begin
                ...
                // update line buffer เพื่อเก็บข้อมูล 2 แถวก่อนหน้า
                gray_line_2[pixel_x] <= old_line_1;
                gray_line_1[pixel_x] <= gray_now;

                // เลื่อนหน้าต่าง 3x3 ของภาพ grayscale
                win00 <= win01;
                win01 <= win02;
                win02 <= old_line_2;
                ...
                case (mode)
                    ...
                    default: begin
                        // edge detection แบบ Sobel คร่าว ๆ
                        // ขอบภาพช่วงต้นให้เป็นสีดำก่อนเพื่อลด artifact
